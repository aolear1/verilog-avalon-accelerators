...
set_module_property AUTHOR "Aiden O'Leary"
set_module_property ICON_PATH ./bama.png
...
set_interface_property reset_n associatedClock clock_in
...
add_interface_port wire vga_clk vga_clk Output 1
add_interface_port wire vga_vsync vga_vsync Output 1
add_interface_port wire vga_hsync vga_hsync Output 1
add_interface_port wire vga_red vga_red Output 8
add_interface_port wire vga_grn vga_grn Output 8
add_interface_port wire vga_blu vga_blu Output 8
